...
type BulkAction = 'activate' | 'deactivate' | 'delete' | 'change_role'
...
export default function EmployeesPage() {
  ...
  const [createFormData, setCreateFormData] = useState({ email: '', full_name: '' })
  ...
  async function handleInvite() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setCreateFormData({ email: '', full_name: '' })
        await fetchEmployees()
        if (!data.invite_url) {
          setTimeout(() => {
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-foreground-secondary mt-1">Gestiona los empleados del sistema</p>
        </div>
      ...
      <Card>
        <CardHeader className="border-b border-border-subtle">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            <CardTitle className="text-base font-semibold">Lista de Empleados</CardTitle>
          ...
          {inviteUrl ? (
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-foreground-secondary">
                El empleado recibirá un correo con el enlace para crear su contraseña.
              </p>
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2 border-t border-border">
              ...
              <p className="text-xs text-foreground-secondary mt-1 text-center">
                Se enviará un email al empleado para crear nueva contraseña
              </p>
            </div>
          ...
          <div className="space-y-4">
            <p className="text-sm text-foreground-secondary">
              Estás a punto de <strong className="text-foreground">{
                ...
                'cambiar el rol de'
              }</strong> a <strong className="text-foreground">{selectedIds.size}</strong> empleado(s).
            </p>
            ...
            {selectedBulkAction === 'delete' && (
              <div className="p-3 bg-error-muted border border-error/20 rounded-lg">
                <p className="text-sm text-error">
                  <strong>Advertencia:</strong> Esta acción no se puede deshacer. Los empleados eliminados perderán acceso al sistema.
                </p>
              </div>
            )}
